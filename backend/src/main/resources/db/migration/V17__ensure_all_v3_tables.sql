-- V17: Create all V3 tables missing from Supabase cloud DB.
-- validate-on-migrate is disabled so this will execute without checksum
-- conflicts. Every statement uses IF NOT EXISTS so it is safe to re-run.
