...
async def config() -> dict:
    return {
        ...
        "agentOrchestrationEnabled": settings.AGENT_ORCHESTRATION_ENABLED,
        "controlledAiJobsEnabled": settings.CONTROLLED_AI_JOBS_ENABLED,
        "aiJobAllowedDataSources": settings.AI_JOB_ALLOWED_DATA_SOURCES,
        "aiJobRequireFreshnessCheck": settings.AI_JOB_REQUIRE_FRESHNESS_CHECK,
        "aiJobMaxPollSeconds": settings.AI_JOB_MAX_POLL_SECONDS,
        "maxAgentResultRows": settings.MAX_AGENT_RESULT_ROWS,
