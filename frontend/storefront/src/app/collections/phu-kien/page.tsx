...
export async function generateMetadata() {
  ...
  return {
    title: collectionMetaCopy[language].accessories
  };
}
      ...
      <main>
        <div className="breadcrumb-wrap">
          <div className="shell breadcrumb">
            ...
            <span>/</span>
            <span>{collectionMetaCopy[language].accessoriesBreadcrumb}</span>
          </div>
        </div>

        <AllProductsCatalog preset="accessories" language={language} />
      </main>
