...
export async function generateMetadata() {
  ...
  return {
    title: collectionMetaCopy[language].futsal
  };
}

export default async function FutsalShoesPage() {
  const language = await getRequestLanguage();
      ...
      <main>
        <div className="breadcrumb-wrap">
          <div className="shell breadcrumb">
            ...
            <span>/</span>
            <span>{collectionMetaCopy[language].futsalBreadcrumb}</span>
          </div>
        </div>

        <AllProductsCatalog preset="futsal" language={language} />
      </main>
