    ...
    <aside className="w-full lg:w-64 lg:shrink-0">
      ...
      <div className="mt-6 flex gap-3">
        <button
          ...
          className="h-10 flex-1 rounded-full border border-ivy-dark text-[13px] font-semibold uppercase tracking-wider text-ivy-dark hover:bg-gray-50"
        >
          Bỏ lọc
        </button>
        <button
          ...
          className="h-10 flex-1 rounded-full bg-ivy-dark text-[13px] font-semibold uppercase tracking-wider text-white hover:opacity-90"
        >
          Lọc
        </button>
      </div>
